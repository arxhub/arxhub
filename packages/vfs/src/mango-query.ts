export namespace MangoQuery {
  // original from https://github.com/maxnowack/signaldb/blob/main/packages/base/core/src/types/Selector.ts
  ...
  export type Selector<T extends Record<string, any>> = Query<T>
}
