...
export function createAuthGuard(authenticator: RequestAuthenticator, logger?: Logger): AnyElysia {
...
export interface ProtectionServerPluginArgs extends PluginArgs, RequestAuthenticatorOptions {}
...
export class ProtectionServerPlugin extends Plugin {
  ...
  override configure(ctx: PluginContext): void {
    ...
    gateway.use(createAuthGuard(this.authenticator, this.logger))
  }
}
